...
public class BuyOrder extends Order {
	...
	public BuyOrder(String ticker, Double level, Double size) {
	...
	public void aggress_order(Order other_order) {
		...
		if (other_order instanceof SellOrder && this.ticker.equals(other_order.ticker)) {
	...
	public String toString() {
		...
		return "Buy " + this.size + " " + this.ticker + " @ $" + this.level;
